...
const Client = () => {
    return (
        <div className="relative flex flex-col items-center justify-center mt-2 bg-white-dark lg:h-screen lg:py-0 py-16">
            ...
            <p className="lg:w-2/6 w-full xl:px-0 lg:px-0 md:px-36 px-5 text-black-light">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor. Lorem ipsum dolor sit amet, consetetur sadipscing elitr,</p>
