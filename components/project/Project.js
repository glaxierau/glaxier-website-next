        ...
        <>
            <div id="project" className="relative flex flex-col items-center justify-center -mt-3 lg:h-96 h-60">
                ...
                <div className="absolute lg:top-24 top-12 z-10 flex flex-col items-center justify-center">
                    ...
                    <AppButton customized={true} title={ctaButton.buttonText} width={200} bgColor="bg-transparent" bgColorHover="hover:bg-white" txtColor="text-white" txtColorHover="hover:text-blue-dark" />
                </div>
            </div>
            <style jsx>
                {
