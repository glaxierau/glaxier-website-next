...
const SearchBox = ({ shadow, border = false, ...otherProps }) => {
    return (
        <div className={`w-full h-12 bg-white ${shadow && 'shadow-lg'} ${border && 'border-2'} border-purple  rounded-3xl flex justify-around items-center`}>
            ...
            <input placeholder="Search" className="w-11/12 text-base text-purple" {...otherProps} />
