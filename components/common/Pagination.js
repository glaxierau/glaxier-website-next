...
export default function Pagination({ items = 5 }) {
    ...
    return (
        <div className='grid place-items-center w-screen px-auto my-10'>
            <div className='flex justify-center items-center text-purple '>
                <Link href={{
                    href: '',
                    query: { page: +currentPage === 1 ? +currentPage : +currentPage - 1 }
                }}
                    passHref>
                ...
                <Link
                    href={{
                        href: '',
                        query: { page: +currentPage === arr.length ? +currentPage : +currentPage + 1 }
                    }}
                    passHref>
