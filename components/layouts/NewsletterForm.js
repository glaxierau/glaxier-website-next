...
const NewsletterForm = ({ status, message, onValidated }) => {
    ...
    return (
        <>
            <div className={`relative flex items-center justify-between w-full bg-white rounded-full p-6 h-12 mt-5 transition-opacity ${status === 'error' ? 'outline outline-yellow-400 shadow-md' : 'outline-none'}`}>
