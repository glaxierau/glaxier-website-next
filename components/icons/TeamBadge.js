...
const TeamBadge = ({ name = "Name", position = "position", img }) => {
    ...
    return (
        <div className="lg:w-52 lg:h-52 md:w-44 md:h-44 w-36 h-36 relative rounded-full flex items-center justify-center overflow-hidden shadow-sm lg:m-1 md:m-1 m-2">
            <img src={img ? img : defaultImage}
            />
            <div className="absolute bottom-0 lg:py-2 sm:py-1 w-full flex flex-col items-center justify-center text-white" style={{ backgroundColor: 'rgba(0, 0, 0, 0.1)', boxShadow: '0px 1px 9px 10px rgba(0,0,0,0.1)' }}>
