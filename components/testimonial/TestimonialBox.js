...
const TestimonialBox = () => {
    return (
        <div className="mx-5 h-60 flex flex-col items-start justify-center">
            ...
            <br />
            <p className="text-black-light text-sm">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor.</p>
