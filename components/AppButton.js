...
const AppButton = ({ title, width, height, link = null, txtColor, txtColorHover, bgColor, bgColorHover, customized = false, disabled = false, type = "button", clicked, ...other }) => {
