...
const CurvyLine = ({ width, color, height }) => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" className="absolute -bottom-2 -z-10" width={width} height={height ? height : '24.999'} viewBox="0 0 250.023 24.999">
