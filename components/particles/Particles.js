...
const Particles = () => {
    ...
    return (
        <div>
            ...
            <SmCircle size={sm ? "5" : "10"} style={sm ? { top: '12rem', left: '5%' } : { top: '5rem', right: '33%' }} />
            <SmCircle size={sm ? "3" : "6"} style={sm ? { top: '40rem', right: '10%' } : { top: '4rem', right: '10%' }} />
            <SmCircle size={sm ? "3" : "6"} style={sm ? { top: '22rem', left: '18%' } : { top: '22rem', left: '18%' }} />
            <SmCircle size={sm ? "5" : "10"} style={sm ? { bottom: '3.5rem', left: '31%' } : { bottom: '3.5rem', left: '31%' }} />
            <SmCircle size={sm ? "3" : "6"} style={sm ? { bottom: '1.5rem', right: '33%' } : { bottom: '1.5rem', right: '33%' }} />
            <SmCircle size={sm ? "5" : "10"} style={sm ? { bottom: '20rem', right: '13%' } : { bottom: '20rem', right: '13%' }} />
        </div>
    )
}
