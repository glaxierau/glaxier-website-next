    ...
    return (
        <div className={`bg-white-dark ${paddingBottom ? 'py-10' : 'pt-10'} `}>
            ...
            <div className="h-screen  mt-20  flex justify-center items-center relative text-center overflow-visible" style={{ width: '100%' }}>
                <img src={`/assets/img/home/${mobileView ? 'smCircles' : 'lgCircles'}.png`} className={"circle_image absolute top-0 z-10 w-full lg:object-cover md:object-cover object-cover h-screen"} alt="circles" />
                <Particles />
