    ...
    return (
        <motion.div className={`bg-white-dark ${paddingBottom ? 'py-10' : 'pt-10'} `}
            ...
            <div className="lg:px-44 md:px-40 px-4">
                ...
                <SlideIn delay={0.6} ><h1 className="lg:text-3xl md:text-3xl text-2xl font-extrabold text-red mb-8">{props.title}</h1></SlideIn>
                <SlideIn delay={0.8} className="lg:w-2/3 md:1/2 w-full"><BlockContent blocks={props.sectionDescription} /></SlideIn>
            </div>
            <FadeIn delay={0.7}>
