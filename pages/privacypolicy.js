...
export default function PrivacyPolicy(props) {
    return (
        <div>
            <Head
                title={'Privacy Policy - Glaxier'}
                description={"Glaxier's privacy policy"}
            />
            <div className="grid justify-center lg:w-[80vw] md:w-[95vw] w-[92vw] mx-auto mt-20">
                ...
                <div className="justify-center max-w-3xl mx-auto mb-10">
                    <div className="text-black">
                        ...
                        collect in Glaxier Website. This policy is not
                        applicable to any information collected offline or via
                        channels other than this website. <br /> <br />
                        <h2>Consent</h2>
                        ...
                        you may choose to provide. <br /> <br />
                        ...
                        <h2>Log Files</h2>
                        Glaxier Website follows a standard procedure of using
                        ...
                        by log files includes internet protocol (IP) addresses,
                        ...
                        of the information is to analyze trends, administer the
                        site, track users' movement on the website, and gather
                        demographic information.
                        <h2>Cookies and Web Beacons</h2>
                        Like any other website, Glaxier Website uses 'cookies'.
                        ...
                        Cookies article at
                        https://www.cloudflare.com/en-au/learning/privacy/what-are-cookies/
                        <h2>Our Advertising Partners</h2>
                        Some advertisers on our site may use cookies and web
                        ...
                        each of the advertising partners of Glaxier Website.
                        <br /> <br />
                        ...
                        on Glaxier Website, which are sent directly to users'
                        ...
                        <br /> <br />
                        Note that Glaxier Website has no access to or control
                        over these cookies that are used by third-party
                        advertisers.
                        <h3>Third-Party Privacy Policies</h3>
                        Glaxier Website's Privacy Policy does not apply to other
                        ...
                        certain conditions. The right to data portability – You
                        ...
                        <br /> <br />
                        Glaxier Website does not knowingly collect any Personal
                        ...
                        contact us immediately and we will make our best efforts
