...
export default function PrivacyPolicy(props) {
    return (
        <div>
            <Head
                title={'Terms and Conditions - Glaxier'}
                description={"Glaxier's terms and conditions"}
            />
            <div className="grid justify-center lg:w-[80vw] md:w-[95vw] w-[92vw] mx-auto mt-20">
                <Title title={'Terms and Conditions'} lineWidth={150} />
                <div className="h-14 w-full"></div>
                <br />
                <br />
                <div className="justify-center max-w-3xl mx-auto mb-10">
                    <strong>Last updated 1 January 2021</strong>
                    <br />
                    <br />
                    <strong>AGREEMENT TO OUR LEGAL TERMS</strong>
                    <p className="mb-4">
                        We are Glaxier AUNZ Pty Ltd ('Company', 'we', 'us', or
                        'our'), a company registered in Australia at 76-84
                        Brunswick Street, Fortitude Valley, Queensland 4006,
                        Australia.
                    </p>
                    <p className="mb-4">
                        We operate the website https://glaxier.com.au (the
                    ...
                    <p className="mb-4">
                        You can contact us by phone at PHONE, email at EMAIL, or
                        by mail to 76-84 Brunswick Street, Fortitude Valley,
                        Queensland 4006, Australia.
                    </p>
                    <p className="mb-4">
                        These Legal Terms constitute a legally binding agreement
                        made between you, whether personally or on behalf of an
                        entity ('you'), and Glaxier AUNZ Pty Ltd, concerning
                    ...
                    <p className="mb-4">
                        ...
                        modifications to these Legal Terms at any time and for
                    ...
                    <h2 className="text-xl mx-6">OUR SERVICES</h2>
                    <p className="mb-4">
                    ...
                    <p className="mb-4">
                        ...
                        EMAIL. If we ever grant you the permission to post,
                    ...
                    <h2 className="text-xl mx-6">Your submissions</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-xl mx-6">USER REPRESENTATIONS</h2>
                    <p className="mb-4">
                        By using the Services, you represent and warrant that:
                        (1) you have the legal capacity and you agree to comply
                        with these Legal Terms; (2) you are not a minor in the
                        jurisdiction in which you reside; (3) you will not
                        access the Services through automated or non-human
                        means, whether through a bot, script or otherwise; (4)
                        you will not use the Services for any illegal or
                        unauthorised purpose; and (5) your use of the Services
                        will not violate any applicable law or regulation. If
                    ...
                    <h2 className="text-xl mx-6">PROHIBITED ACTIVITIES</h2>
                    <p className="mb-4">
                    ...
                    <ul>
                        ...
                        <li>
                            ...
                            Content for any revenue-generating endeavour or
                    ...
                    <h2 className="text-xl mx-6">CONTRIBUTION LICENCE</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-xl mx-6">SERVICES MANAGEMENT</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-xl mx-6">PRIVACY POLICY</h2>
                    <p className="mb-4">
                        We care about data privacy and security. Please review
                        our Privacy Policy:
                        https://glaxier.com.au/privacypolicy. By using the
                        Services, you agree to be bound by our Privacy Policy,
                        which is incorporated into these Legal Terms. Please be
                        advised the Services are hosted in Australia and
                        Thailand. If you access the Services from any other
                        region of the world with laws or other requirements
                        governing personal data collection, use, or disclosure
                        that differ from applicable laws in Australia and
                        Thailand, then through your continued use of the
                        Services, you are transferring your data to Australia
                        and Thailand, and you expressly consent to have your
                        data transferred to and processed in Australia and
                        Thailand.
                    </p>
                    <h2 className="text-xl mx-6">TERM AND TERMINATION</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-xl mx-6">GOVERNING LAW</h2>
                    <p className="mb-4">
                        These Legal Terms shall be governed by and defined
                        following the laws of Australia. Glaxier AUNZ Pty Ltd
                        and yourself irrevocably consent that the courts of
                        Australia shall have exclusive jurisdiction to resolve
                        any dispute which may arise in connection with these
                        Legal Terms.
                    </p>
                    <h2 className="text-xl mx-6">DISPUTE RESOLUTION</h2>
                    <p className="mb-4">
                        You agree to irrevocably submit all disputes related to
                        these Legal Terms or the legal relationship established
                        by these Legal Terms to the jurisdiction of the
                        Australia courts. Glaxier AUNZ Pty Ltd shall also
                        maintain the right to bring proceedings as to the
                        substance of the matter in the courts of the country
                        where you reside or, if these Legal Terms are entered
                        into in the course of your trade or profession, the
                        state of your principal place of business.
                    </p>
                    <h2 className="text-xl mx-6">CORRECTIONS</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-xl mx-6">DISCLAIMER</h2>
                    <p className="mb-4">
                        ...
                        USE OF THE SERVICES, (3) ANY UNAUTHORISED ACCESS TO OR
                        ...
                        YOUR BEST JUDGEMENT AND EXERCISE CAUTION WHERE
                        APPROPRIATE.
                    </p>
                    <h2 className="text-xl mx-6">LIMITATIONS OF LIABILITY</h2>
                    <p className="mb-4">
                    ...
                    <h2 className="text-xl mx-6">INDEMNIFICATION</h2>
                    <p className="mb-4">
                        ...
                        of: (1) use of the Services; (2) breach of these Legal
                        Terms; (3) any breach of your representations and
                        warranties set forth in these Legal Terms; (4) your
                    ...
                    <h2 className="text-xl mx-6">MISCELLANEOUS</h2>
                    <p className="mb-4">
