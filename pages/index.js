...
export default function Home(props) {
    return (
        <div className="">
            <Head
                title={props.pageInfo.metadata.metaTitle}
                description={props.pageInfo.metadata.mataDescription}
            />
            <Banner {...props} />
...
export async function getStaticProps(context) {
    ...
    const props = await getData(
        `*[_type =='home'  && pageInfo.lang->language == 'en-au'][0]{
          ..., 
          aboutSection->,
          ...
          testimonialSection{
            ...,testimonials[]-> {
              ...,
              "logo": client->logo,
              content[language->language == 'en-au']{
                ...
              }
            }
          }
